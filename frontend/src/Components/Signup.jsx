    ...
    <div className='relative overflow-hidden flex items-center justify-center  pb-10 h-screen w-full '>
      ...
      <div className=''>
        ...
        <div className='w-110 h-140 rounded-3xl bg-white'>
          ...
          <h1 className='text-center'>Just Signup To Join Us!</h1>
        ...
        <div className="text-red-500 text-center mt-4">{errorMessage}</div>
          ...
          <div className='text-center p-3'>Already have an account? <Link to={"/login"} className='text-blue-500 hover:text-blue-600' >Login</Link></div>
          </form>
